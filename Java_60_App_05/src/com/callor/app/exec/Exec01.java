 ...
 *  데이터를 정렬하는 알고리즘이다
 *  코드가 매우 단순해서 조금만 살펴보면 쉽게 이해할수 있다.
 *  insert 정렬과 비교 했을때 비교하는 방법에서 조금 차이가 있다
 *  큰 데이터가 아닐경우는 insert 정렬에 비해 더 빠르다 => 선생님 개인적 생각
 */
public class Exec01 {
