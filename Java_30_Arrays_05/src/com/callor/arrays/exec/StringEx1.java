...
public class StringEx1 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 문자열형 변수는 숫자형, 불린형 변수와 저장 방식이
		 * 다르다
		 * 때문에 문자열형 변수에 저장된 문자열을 EQ(==) 비고를
		 * 하는것은 매우 위험한 코드가 될수 있다
		 * 
		 * 문자열형 변수는 
		...
		String strName = new String("ghd");
		System.out.println(strName);
		System.out.println(strName == "ghd");
		
		System.out.println(strNation.equals("KOREA"));
		System.out.println(strName.equals("ghd"));
		
		boolean bYes = strNation.equals("KOREA");
		if(bYes) {
			System.out.println("strNation 변수에는 \"KOREA\"가 담겨 있다");
		}
		bYes = strName.equals("ghd");
