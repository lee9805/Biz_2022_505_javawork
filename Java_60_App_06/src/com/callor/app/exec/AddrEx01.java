...
public class AddrEx01 {
		...
		public static void main(String[] args) {
			 ...
			 * 각각 주소데이터에는 이름, 주소, 전화번호, 나이, 취미등이 필요할것이다
			 * 이 데이터들을 개별적인 변수로 선언을 하여 사용할수도 있다
			 * 각각의 배열로 선언하여 사용할수 도 있다
			 * 
			 ...
			 * 연산결과를 return 할때도 객체 단우리 이동이 가능하다
			 */
			...
			hong.setAddr("광주시");
			hong.setAge(25);
			hong.setTel("010-0101-0101");
			hong.setHaddy("운동");

			lee.setName("이몽룡");
			lee.setAddr("서울시");
			lee.setAge(26);
			lee.setTel("010-0202-0202");
			lee.setHaddy("그림");
			
			sung.setName("성춘향");
			sung.setAddr("광주시");
			sung.setAge(24);
			sung.setTel("010-0102-0101");
			sung.setHaddy("요리");
