...
public class CatingEx01 {
	...
	public static void main(String[] args) {
		 ...
		 * 크기가 큰 type의 변수 값을 복사 대입하는 경우
		 * 값을 잃을 수 있다
		 * 하지만 억지로 대하고 한다면
		 * "강제 형 변환(Cating)" 을 수행해야 한다
		 * 강제 형 변환을 수행했을 때 예측 할수 없는 결과가 나올수 있고
		 * 그 책임은 순전히 개발자 몫이다
		 */
		 ...
		 * 강제로 형변환을 하여 실수값을 정수형 변수에 대입하기도한다
		 */
		intNum1 = (int)3.0;
		intNum1 += 3.0;
		 ...
		 * 갓을 예측할 수 없고 논리적인 문제를 일으키지 않으면
		 * "많은 값을 대입"하여 오류를 방지해야한다
		*/
		intNum1 =0;
		intNum1 +=3.123123;
