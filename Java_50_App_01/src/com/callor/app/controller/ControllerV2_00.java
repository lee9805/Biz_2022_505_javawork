...
public class ControllerV2_00 {
	...
	public static void main(String[] args) {
		...
		*intList를 초기화 하는 코드가 없고
		*ServiceV2 를 호출하는 외부에서(Controller)
		*초기화된 list 를 매개 변수로 
		*주입해서 사용해야 하기 때문에
		*
		*만약 기본생서자를 호출하여 객체를 만들게 되면
		* intList 에서 Nullpointer Exception 이 발생할 것이다
		* 그러한 이유로 기본 생성자를 아예 호출하지 못하도록 만든다
		* 기본 생성자에서 intList를 초기화 하는 코드를 
		...
		*/
		...
		//List interface 를 상속 받은 구현 클래스들
